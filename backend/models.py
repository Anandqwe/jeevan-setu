...
class Incident(Base):
    ...
    hospital_ready = Column(Boolean, nullable=False, default=False)
    patient_reached_hospital = Column(Boolean, nullable=False, default=False)
    eta_minutes = Column(Integer, nullable=True)
    distance_km = Column(Float, nullable=True)
    ambulance_last_lat = Column(Float, nullable=True)
    ambulance_last_lng = Column(Float, nullable=True)
    ambulance_last_seen_at = Column(DateTime, nullable=True)
    arrived_at_hospital_at = Column(DateTime, nullable=True)
